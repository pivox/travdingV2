...
from src.interface.cli.commands import run_analyse, run_fetch, run_fetch_contracts
...
def main():
    ...
    parser.add_argument('--mode', choices=['api', 'analyse', 'fetch', 'fetch_contracts'], required=True)
